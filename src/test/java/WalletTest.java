...
public class WalletTest {
    ...
    void expensesByCategory() {
        ...
        assertEquals(EXPECTED_EXPENSE_ENTERTAINMENT, wallet.getExpensesByCategory(CATEGORY_ENTERTAINMENT));
    ...
    void getRemainingBudgetZeroOrNegative() {
        assertEquals(EXPECTED_REMAINING_BUDGET_ENTERTAINMENT, wallet.getRemainingBudget(CATEGORY_ENTERTAINMENT));
        assertEquals(EXPECTED_REMAINING_BUDGET_UTILITIES, wallet.getRemainingBudget(CATEGORY_UTILITIES));
    }
    ...
    void saveCategoryBudgetUpdatesLimit() {
        ...
        assertEquals(BUDGET_FOOD_UPDATED - EXPECTED_EXPENSE_FOOD, wallet.getRemainingBudget(CATEGORY_FOOD));
    }
